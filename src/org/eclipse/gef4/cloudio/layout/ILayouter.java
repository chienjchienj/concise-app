...
public interface ILayouter {
	 ...
	 * @return
	 */
	public boolean layout(Point initial, final CloudWord word, final Rectangle cloudArea, CloudMatrix cloudMatrix);
	 ...
	 * @return
	 */
	public Point getInitialOffset(CloudWord word, Rectangle cloudArea);
